...
func defaultPriorities() sets.String {
	return sets.NewString(
		...
		// spreads pod by consideration of (ps task and worker task)'s affinity
		factory.RegisterPriorityFunction("DeepLearningTaskAllocationPriority", priorities.DeepLearningTaskAllocationPriority, 1),
